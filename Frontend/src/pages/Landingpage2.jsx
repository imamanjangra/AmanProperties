...
export default function Landingpage2() {
  ...
  return (
    <div className="font-sans">
      ...
      <footer className="bg-gradient-to-br from-[#f5f2ed] via-white to-[#f5f2ed] border-t border-gray-200">
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-11 h-11 bg-gradient-to-br from-[#c6a46c] to-[#b8955a] rounded-xl flex items-center justify-center shadow-md">

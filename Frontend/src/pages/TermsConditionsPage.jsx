...
export default function TermsConditionsPage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-[#f5f2ed] via-white to-[#f5f2ed] py-16 px-4">
        <SEO title="Terms & Conditions | Aman Properties" description="Read the terms and conditions for using AmanProperties. Understand our policies, your rights, and obligations as a user of our platform." />

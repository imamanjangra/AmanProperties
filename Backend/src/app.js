...
app.use(
  cors({
    origin: [
      ...
      "http://localhost:5173" ,"http://localhost:3000" ,"http://localhost:5174" , "https://amanproperties.onrender.com" , "https://amanproperties-admin.onrender.com" , "https://aman-properties.vercel.app"
    ],
    credentials: true,
  })
);
